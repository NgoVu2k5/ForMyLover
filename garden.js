...
Petal.prototype={
    draw:function(){
        ...
        c=e.clone().mult(this.stretchA);b=d.clone().mult(this.stretchB);
...
Garden.options={
    ...
    bloomRadius:{min:8,max:8},
    density:10,
    growSpeed:1000/70,
    color:{
        rmin:50,rmax:50,gmin:205,gmax:205,bmin:50,bmax:50,opacity:0.2
    },
    tanAngle:60};
...
Garden.randomrgba=function(i,n,h,m,l,d,k){
    ...
    var e=5;if(Math.abs(c-f)<=e&&Math.abs(f-j)<=e&&Math.abs(j-c)<=e){
